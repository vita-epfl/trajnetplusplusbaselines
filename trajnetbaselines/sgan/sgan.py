...
class SGAN(torch.nn.Module):
    ...
    def forward(self, observed, prediction_truth=None, n_predict=None):
        ...
        """
        return self.generator(observed, prediction_truth, n_predict)
...
#         ## Classifier
#         real_classifier_dims = [self.hidden_dim, self.hidden_dim / 2, self.hidden_dim / 4, 1]
...
#         scores = self.real_classifier(hidden_cell_state)
#         return scores
